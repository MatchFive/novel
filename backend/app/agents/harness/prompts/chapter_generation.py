...
- **时间线/因果矛盾**：正文中的解释或归因与【前文尾部】、【角色】、【世界观】中的时间信息冲突。例如，若某个角色（如原主、前任子爵）近期才去世或登场，就不能把他作为”税收连年下降””领地长期荒废”等多年现象的原因。
- 文风、篇幅问题不列入 issues。
...
请继续按照细纲顺序撰写下一段正文（800-1200 字），与上一段自然衔接。
- 若细纲中仍有未写完的场景，请继续推进，输出 finished=false。
- 只有当细纲的所有场景都已在正文中完整呈现，才可输出 finished=true。
